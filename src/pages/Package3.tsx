...
import islandAnimation from '../res/animations/City.json'; // Adjust the animation path
...
import destinationImage1 from '../res/images/twincity1.jpg'; // Update the image path
import destinationImage2 from '../res/images/twincity2.jpg'; // Update the image path
import destinationImage3 from '../res/images/twincity3.jpg'; // Update the image path
import destinationImage4 from '../res/images/twincity4.jpg'; // Update the image path
import footerImage from '../res/images/cebu1.jpg';

const headerTexts = [
  { title: 'Discover', location: 'Twin City Tour' },
  { title: 'Experience', location: 'Uphill Tour' },
  { title: 'Explore', location: 'Historic Sites' },
  { title: 'Enjoy', location: 'Scenic Views' },
];
...
const tourDetails = {
    ...
    itinerary: [
      ...
      '9:00 AM - Visit Magellan\'s Cross',
      '10:00 AM - Explore Fort San Pedro',
      '11:00 AM - Basilica del Santo Niño',
      '12:00 PM - Lunch at a local restaurant',
      '1:30 PM - Taoist Temple',
      '3:00 PM - Sirao Flower Garden',
      '4:30 PM - Temple of Leah',
...
const PrivateTourPackage: React.FC = () => {
  ...
  const destinations = [
    { id: 1, name: 'Twin City Tour', price: 'Php 5500 / PAX', image: destinationImage1 },
    { id: 2, name: 'Uphill Tour', price: 'Php 5500 / PAX', image: destinationImage2 },
    { id: 3, name: 'Historic Sites', price: 'Php 5500 / PAX', image: destinationImage3 },
    { id: 4, name: 'Scenic Views', price: 'Php 5500 / PAX', image: destinationImage4 },
  ];
    ...
    <div className="min-h-screen flex flex-col w-full bg-gray-100">
      ...
      >
        ...
        <div className="relative z-10 py-16 flex flex-col justify-center items-center h-full">
          ...
          >
            Private Twin City Tour with Uphill Tour
          </motion.p>
          <motion.button
            initial={{ opacity: 0, y: -50 }}
            animate={{ opacity: 1, y: 0 }}
