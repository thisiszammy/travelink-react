...
import safariAnimation from '../res/animations/Island.json'; // Adjust the animation path
...
import safariImage1 from '../res/images/safari1.jpg';
import safariImage2 from '../res/images/safari2.jpg';
import safariImage3 from '../res/images/safari3.jpg';
import safariImage4 from '../res/images/safari4.jpg';
import footerImage from '../res/images/cebu1.jpg';

const headerTexts = [
  { title: 'Discover', location: 'Cebu Safari' },
  { title: 'Experience', location: 'Adventure' },
  { title: 'Explore', location: 'The Park' },
  { title: 'Enjoy', location: 'Nature' },
];
...
const tourDetails = {
  ...
  itinerary: [
    ...
    '9:00 AM - Arrival at Cebu Safari and Adventure Park',
    '9:30 AM - Tour around the park',
    '12:00 PM - Lunch',
    '1:00 PM - Continue exploring the park',
    '3:00 PM - Animal Encounter',
    '5:00 PM - Departure back to your hotel'
  ],
  whatToExpect: [
    'A fun-filled day with various animals',
    'Guided tour of the park',
    'Interaction with some animals',
...
const PrivateTourPackage: React.FC = () => {
  ...
  const destinations = [
    { id: 1, name: 'Cebu Safari and Adventure Park', price: 'Php 3500 / PAX', image: safariImage1 },
    { id: 2, name: 'Wildlife Adventure', price: 'Php 3500 / PAX', image: safariImage2 },
    { id: 3, name: 'Nature Walk', price: 'Php 3500 / PAX', image: safariImage3 },
    { id: 4, name: 'Animal Encounter', price: 'Php 3500 / PAX', image: safariImage4 },
  ];
    ...
    <div className="min-h-screen flex flex-col w-full bg-gray-100">
      ...
      >
        ...
        <div className="relative z-10 py-16 flex flex-col justify-center items-center h-full">
          ...
          <Lottie animationData={safariAnimation} loop={true} style={{ width: 570, height: 300 }} />
          <motion.p
          ...
          >
            Cebu Safari and Adventure Park Tour
          </motion.p>
          <motion.button
            initial={{ opacity: 0, y: -50 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="container mx-auto text-center">
          ...
          <p className="text-gray-600 mb-8">
            Discover the best spots to visit in Cebu Safari and Adventure Park
          </p>
