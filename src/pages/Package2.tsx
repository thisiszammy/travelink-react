...
import destinationImage4 from '../res/images/pescador.jpg';
...
const headerTexts = [
  ...
  { title: 'Enjoy', location: 'Pescador Island' },
];
...
const tourDetails = {
    name: 'Whale Shark + Tumalog Falls + Kawasan Falls + Pescador Island',
    ...
    <div className="min-h-screen flex flex-col w-full bg-gray-100">
      ...
      >
        ...
        <div className="relative z-10 py-16 flex flex-col justify-center items-center h-full">
          ...
          >
            Whale Shark + Tumalog Falls + Sumilon Sandbar + Pescador Island
          </motion.p>
          <motion.button
            initial={{ opacity: 0, y: -50 }}
            animate={{ opacity: 1, y: 0 }}
