...
import islandImage1 from '../res/images/moalboal.jpg';
import islandImage2 from '../res/images/oslob.jpg';
import islandImage3 from '../res/images/kawasan.jpg';
import islandImage4 from '../res/images/sumilon.jpg';
import dishImage1 from '../res/images/cebu1.jpg';

const headerTexts = [
  { title: 'Dive in to', location: 'South Cebu' },
...
const SouthCebuPage: React.FC = () => {
  ...
  const destinations = [
    { id: 1, name: 'Moalboal', price: 'Php 1500 / DAY', image: islandImage1 },
    { id: 2, name: 'Oslob', price: 'Php 2500 / DAY', image: islandImage2 },
    { id: 3, name: 'Kawasan Falls', price: 'Php 1800 / DAY', image: islandImage3 },
    { id: 4, name: 'Sumilon Island', price: 'Php 2000 / DAY', image: islandImage4 },
  ];
    ...
    <div className="min-h-screen flex flex-col w-full bg-gray-100">
      ...
      >
        ...
        <div className="relative z-10 py-16 flex flex-col justify-center items-center h-full">
          ...
          >
            LET US TAKE YOU TO THE PARADISE IN THE SOUTH
          </motion.p>
          <motion.button
            initial={{ opacity: 0, y: -50 }}
            animate={{ opacity: 1, y: 0 }}
