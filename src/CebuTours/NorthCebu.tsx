...
import islandImage1 from '../res/images/island1.jpg';
import islandImage2 from '../res/images/island2.jpg';
import islandImage3 from '../res/images/island3.jpg';
import islandImage4 from '../res/images/carnaza.jpg';
import dishImage1 from '../res/images/cebu1.jpg';

const headerTexts = [
  { title: 'Discover', location: 'North Cebu' },
  { title: 'Experience', location: 'Paradise' },
  { title: 'Explore', location: 'The Islands' },
];
...
const NorthCebuPage: React.FC = () => {
  ...
  const destinations = [
    { id: 1, name: 'Malapascua Island', price: 'Php 1500 / DAY', image: islandImage1 },
    { id: 2, name: 'Bantayan Island', price: 'Php 2500 / DAY', image: islandImage2 },
    { id: 3, name: 'Kinatarkan Island', price: 'Php 1800 / DAY', image: islandImage3 },
    { id: 4, name: 'Carnaza Island', price: 'Php 2000 / DAY', image: islandImage4 },
  ];
    ...
    <div className="min-h-screen flex flex-col w-full bg-gray-100">
      ...
      >
        ...
        <div className="relative z-10 py-16 flex flex-col justify-center items-center h-full">
          ...
          >
            LET US TAKE YOU TO THE PARADISE IN THE NORTH
          </motion.p>
          <motion.button
            initial={{ opacity: 0, y: -50 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="container mx-auto text-center">
          ...
          <p className="text-gray-600 mb-8">
            Discover the best spots to visit in North Cebu
          </p>
