...
import { faUser, faBook, faHouse, faSearch, faAdd, faAddressCard, faQuestionCircle } from '@fortawesome/free-solid-svg-icons';
...
const NavigationBar: React.FC = () => {
  ...
  return (
    <div className="navbar">
      ...
      <button
        className={`nav-button ${activeButton === '/addtrip' ? 'active' : ''}`}
        onClick={() => handleClick('/addtrip')}
      >
        <div className="nav-icon">
      ...
      <button
        className={`nav-button ${activeButton === '/faq' ? 'active' : ''}`}
