            ...
            <AnimatePresence>
              {privateToursDropdownOpen && (
                <motion.div
                  ...
                  className="absolute left-0 mt-2 w-48 bg-gray-500 text-white rounded shadow-lg"
                >
                  <Link to="/private-tour-1" className="block px-2 py-3 text-white hover:bg-gray-900 no-underline" onClick={() => setPrivateToursDropdownOpen(false)}>Whale Shark + Tumalog Falls + Sumilon Sandbar + Kawasan Falls</Link>
                  <Link to="/private-tour-2" className="block px-2 py-3 text-white hover:bg-gray-900 no-underline" onClick={() => setPrivateToursDropdownOpen(false)}>Whale Shark + Tumalog Falls + Kawasan Falls + Pescador Island</Link>
                  <Link to="/private-tour-3" className="block px-2 py-3 text-white hover:bg-gray-900 no-underline" onClick={() => setPrivateToursDropdownOpen(false)}>Private Twin City Tour with Uphill</Link>
                  <Link to="/private-tour-4" className="block px-2 py-3 text-white hover:bg-gray-900 no-underline" onClick={() => setPrivateToursDropdownOpen(false)}>Cebu Safari and Adventure Park Tour</Link>
                  <Link to="/private-tour-5" className="block px-2 py-3 text-white hover:bg-gray-900 no-underline" onClick={() => setPrivateToursDropdownOpen(false)}>Bantayan Island Day Tour</Link>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
